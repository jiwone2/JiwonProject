...
<body>
  ...
  <script>
    ...
    new Vue({
    	...
    	mounted : function(){
    		let _this = this;
    		axios.get('http://3.39.41.126/mypage/my_course_vue.do',{
    			params:{
    	...
    	methods : {
    		detail:function(rday){
    			let _this = this;
    			_this.isShow = true;
    			axios.get('http://3.39.41.126:8080/web/mypage/my_course_detail.do', {
    				params : {
    					rday : rday
    				}
    			}).then(function(result){
    		...
    		delBtn:function(no){
    			axios.get('http://3.39.41.126:8080/web/mypage/my_course_delete.do', {
    				params : {
    					no : no
    				}
    			}).then(function(result){
